...
# --- MODIFICATION ICI : Ajout de websockets ---
QT += quick
QT += qml
QT += network
QT += quickcontrols2
...
# Sources C++
# --- ATTENTION : Ajoute ici les autres fichiers .cpp si tu en as (ex: websocketserver.cpp) ---
SOURCES += \
    src/Main.cpp \
    src/websocketserver.cpp

# Headers (Fichiers .h)
# C'est une bonne pratique de les lister aussi
HEADERS += \
